                               ...
                               <div class="small-section-tittle2">
                                ...
                                <div class="select-job-items2">
                                    <select name="select">
                                        ...
                                        <option value="">On Hold  3</option>
                                        <option value="">Closed 4</option>
                                        <option value="">Cancelled 5</option>
                                    </select>
                                </div>
                                    ...
                                    <div class="job-items">
                                        ...
                                        <div class="job-tittle job-tittle2">
                                            ...
                                            <ul>
                                                ...
                                                <li><i class="fas fa-map-marker-alt"></i>Los Angeles, CA</li>
                                                <li>$3000 - $4500</li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        ...
                                        <div class="job-tittle job-tittle2">
                                            ...
                                            <ul>
                                                <li>BizCorp</li>
                                                <li><i class="fas fa-map-marker-alt"></i>Chicago, IL</li>
                                                <li>$6000 - $7500</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="items-link items-link2 f-right">
                                        <a href="job_details.html">Contract</a>
                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        ...
                                        <div class="job-tittle job-tittle2">
                                            ...
                                            <ul>
                                                <li>WriteWell</li>
                                                <li><i class="fas fa-map-marker-alt"></i>Austin, TX</li>
                                                <li>$3000 - $4000</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="items-link items-link2 f-right">
                                        <a href="job_details.html">Freelance</a>
